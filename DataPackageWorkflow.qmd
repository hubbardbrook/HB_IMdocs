...
-   In most cases, a very preliminary zoom with data show and tell occurs to iron out an major issues and to develop a plan for the composition of the data package.
-   Provide submitter with metadata template using [email template](DBD) to outline the process and description of best practices, such as:
    ...
    -   Note that commonly used chunks of metadata can be briefly described without detail, such as author details, geographic locations, taxonomy
